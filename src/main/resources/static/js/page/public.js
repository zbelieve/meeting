...
/**
 * 获取PaperjqGrid选中的一条记录
 * @returns {*}
 */
function getSelectedPaperRow() {
    var grid = $("#PaperjqGrid");
    var rowKey = grid.getGridParam("selrow");
    if (!rowKey) {
        swal("请选择一条记录", {
            icon: "error",
...
/**
 * 获取editroletable选中的多条记录
 * @returns {*}
 */
function getSelectedRoleRows() {
    var grid = $("#editroletable");
    var rowKey = grid.getGridParam("selrow");
    if (!rowKey) {
        swal("请选择一条记录", {
            icon: "error",
