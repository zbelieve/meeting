...
function CQWindow(id, criConfig){
    ...
    // this.containerSize.width = 1166; //改
    ...
    */
    ...
    this.m_ColumnWidth = {'index':35, 'field':80, 'operator':80, 'operand':100, 'del':25};
...
CQWindow.prototype.init = function(){
    ...
    $(this.cItemContentDIV).css("height", 60+"px");
